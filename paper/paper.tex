...
\bibitem{haarslev2007}
  V.~Haarslev, R.~M{\"o}ller, and M.~Wessel,
  ``\textsc{Racer}: An OWL Reasoning Agent for the Semantic Web,''
  in \textit{Proc.\ Int.\ Workshop on Applications of Logic Programming to the Semantic Web}, 2007.
\end{thebibliography}
